...
- Name: product_page_state.spec.js >> Page State >> should add Bolt T-Shirt to an empty cart
- Location: tests/product_page_state.spec.js:87:7
...
Call log:
  - waiting for locator('[data-test="add-to-cart-tta-bolt-tshirt"]')
