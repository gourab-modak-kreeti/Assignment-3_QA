export class Checkout {
  constructor(page) {
    ...
    this.CART_EMPTY=page.locator('[data-test="cart-empty"]');
    this.PAYMENT_INFO_HEADING= page.getByRole("heading", { name: "Payment Information:" });
    this.SHIPPING_INFO_HEADING= page.getByRole("heading", { name: "Shipping Information:" });
    ...
    // Order confirmation
    this.COMPLETE_HEADER = page.getByText("Thank you for your order!");

    this.COMPLETE_MESSAGE = page.getByText("Your order has been dispatched");
    ...
    this.HEADING_PRICE_TOTAL = page.getByRole("heading", {
      name: "Price Total",
    });
  }
}
